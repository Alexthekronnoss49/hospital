package com.alexander.pacientes.controllers;
...
import com.alexander.pacientes.services.PacienteService;
...
public class PacienteController extends CommonController<PacienteRequest, PacienteResponse, PacienteService>{
	...
	public ResponseEntity<PacienteResponse> obtenerPacientesPorIdSinEstado(
			@PathVariable 
